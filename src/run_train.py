...
from src.model_utils import (MLP, add_epilogue, add_prologue,
                             ...
                             compute_and_print_parameters)
from src.kd_utils import get_kd_loss
...
def main():
    ...
    # Setup teacher and student model
    model = setup_teacher_student(model, args, accelerator)

    # There is no teacher model, so we just train the student model
    if args.no_teacher:
        model.teacher = None
